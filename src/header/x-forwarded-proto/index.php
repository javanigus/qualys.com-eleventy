...
/**
 * return the value of the X-Forwarded-Proto header in JSON or JSONP
 */

$data = '';

if (isset($_SERVER) && isset($_SERVER['HTTP_X_FORWARDED_PROTO'])) {
	$data = $_SERVER['HTTP_X_FORWARDED_PROTO'];
} else if (isset($_SERVER) && isset($_SERVER['QMIP'])) {
	$data = $_SERVER['QMIP'];
}
