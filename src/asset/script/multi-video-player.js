...
a(".q-app-video-wrapper.active .poster").addClass("hidden"),a(".q-app-video-wrapper.active .play-icon").addClass("hidden"),f[b].play()}var c=a(".video-link-wrapper"),d=a(".q-app-video-wrapper"),e=a(".q-app-video-wrapper.active").attr("data-video-id"),f={};// create object of all videos fdgds
