...
b&&(a("html, body").animate({scrollTop:a(".q-agenda-container").top},"slow"),a("[data-tab='"+b+"-tab']").trigger("click"))})(jQuery),function(a){"use strict";a(document).ready(function(){// get hash value
var b="";// trigger the click on hash selectors
window.location.hash&&(b=window.location.hash.substring(1),b=0==b.indexOf("/")?b.substring(1):b),a("[href='#"+b+"']").trigger("click")})}(jQuery),function(){"use strict";// init news and events carousel
